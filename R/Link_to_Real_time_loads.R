#' Import and process data in specified folder structure using realTimeloads package. If site is set to NULL code will process data for all site folders under user_data_folder
#'
#' Imports, processes, and imputes data in user_data_folder folders (see note below). Calling this function periodically will check for changes to 000 file size and will appended new data as needed. If site is set to NULL code will process data for all site folders under user_data_folder. After running this function use Compute_load() (see link below)
#'
...
#'
#' @return Processed data in subfolders of user_data_folder/site. See help files of each function below to determine specfic output file location in user_data_folder/site.
#' @seealso
#'
